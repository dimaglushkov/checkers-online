...
if(WIN32)
    ...
    if(NOT ("${CMAKE_GENERATOR_PLATFORM}" STREQUAL "Win64"))
        ...
        set(SDL2_LIBS "${SDL2_ROOT}/x86_64-w64-mingw32/lib/libSDL2.la")
        set(SDL2_DLLS "${SDL2_ROOT}/x86_64-w64-mingw32/bin/SDL2.dll")
        if(_SDL2_use_main)
            list(APPEND SDL2_LIBS "${SDL2_ROOT}/x86_64-w64-mingw32/lib/libSDL2main.la")
        endif()
    else()
        set(SDL2_INCLUDE_DIRS "${SDL2_ROOT}/i686-w64-mingw32/include/SDL2")
        set(SDL2_LIBS "${SDL2_ROOT}/i686-w64-mingw32/lib")
        set(SDL2_DLLS "${SDL2_ROOT}/i686-w64-mingw32/bin/SDL2.dll")
        if(_SDL2_use_main)
            list(APPEND SDL2_LIBS "${SDL2_ROOT}/i686-w64-mingw32/lib/libSDL2main.la")
        endif()
    endif()
