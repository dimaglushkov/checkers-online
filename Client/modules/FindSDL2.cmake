...
if(WIN32)
    # Search for SDL2 Debug CMake build in extern/SDL2-{SDL2_VERSION}-dev/build
    find_path(SDL2_ROOT "include/SDL.h" PATHS "${CMAKE_CURRENT_LIST_DIR}/../extern/SDL2-${SDL2_VERSION}-dev" NO_DEFAULT_PATH)
    if(SDL2_ROOT)
